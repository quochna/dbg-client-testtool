 ...
 * @author hainpt
 */
public class SmsEntranceController extends DbgClientCore
{
    private static Logger logger = Logger.getLogger(SmsEntranceController.class);
    private final String ITEM_SEPARATE = "\\|";
    private final String PARAM_STATS = "stats";
    private final Monitor readStats = new Monitor();

    public SmsEntranceController()
    {
    }
